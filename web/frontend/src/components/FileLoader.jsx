 ...
 *
 * This component fetches available files from the store and allows users to select raw or saved data files for loading.
 * It manages custom directory paths and handles the loading and unloading of selected files.
 * The component also provides a user interface for toggling between raw and saved data views, and for submitting custom paths.
 *
